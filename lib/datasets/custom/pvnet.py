...
class Dataset(data.Dataset):
    ...
    def get_training_img(self, img, kpt_2d, mask):
        ...
        tless_config.train_w, tless_config.train_h))  # w = 720 H = 540 --> utils - tless - tless_config.py
    ...
    def __getitem__(self, index_tuple):
        ...
        if self.split == 'train':
            ...
            # print(img.shape) # 2020.04.15 = 400 * 400
        ...
        # cv2.imwrite("/home/david/pycharmProjects/clean-pvnet/output/test_img/test/{}_output_mask.jpg".format(index), mask_)
        # cv2.imwrite("/home/david/pycharmProjects/clean-pvnet/output/test_img/test/{}_output.jpg".format(index), img_)
